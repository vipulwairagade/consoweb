				...
				<div id="main">
					...
					<!-- Work -->
						<article id="work">
							...
							<div class="row">
								<div class="col s12 m6 blue-grey-text l4">
									<div class="card">
									    ...
									    <div class="card-reveal">
									      ...
									      <br>
									      <a class="brown-text text-darken-4" href="#swades">View more</a></p>
									    </div>
									</div>
								</div>
								<div class="col s12 m6 blue-grey-text l4">
								...
								<div class="col s12 m6 blue-grey-text l4">
									<div class="card">
									    ...
									    <div class="card-reveal">
									      ...
									      <br>
									      <a class="brown-text text-darken-4"href="#ceo">View more</a></p>
									    </div>
									</div>
								</div>
								<div class="col s12 m6 blue-grey-text l4">
									<div class="card">
									    ...
									    <div class="card-reveal">
									      ...
									      <br>
									      <a class="brown-text text-darken-4"href="#silhouette">View more</a></p>
									    </div>
									</div>
								</div>
								<div class="col s12 m6 blue-grey-text l4">
									<div class="card">
									    ...
									    <div class="card-reveal">
									      ...
									      <br>
									      <a class="brown-text text-darken-4"href="#ad-venture">View more</a></p>
									    </div>
									</div>
								</div>
								<div class="col s12 m6 blue-grey-text l4">
									<div class="card">
									    ...
									    <div class="card-reveal">
									      ...
									      <br>
									      <a class="brown-text text-darken-4"href="#bizmantra">View more</a></p>
									    </div>
									</div>
								</div>
							</div>
							  ...
							  <div class="card" id="event-card-bg">
							    <div class="card-tabs">
							      <ul class="tabs tabs-transparent">
							        <li class="tab"><a class="active" href="#swades4">WHAT?</a></li>
							        <li class="tab"><a href="#swades5">WHY?</a></li>
							        <li class="tab"><a href="#swades6">REGISTER</a></li>
							        <li class="tab"><a href="#swades7">CONTACT</a></li>
							      </ul>
							    </div>
					...
					<article id="ceo">
							<h2 class="major">CEO</h2>
							  ...
							  <div class="card" id="event-card-bg">
							    <div class="card-tabs">
							      <ul class="tabs tabs-transparent">
							        <li class="tab"><a class="active" href="#ceo4">WHAT?</a></li>
							        <li class="tab"><a href="#ceo5">WHY?</a></li>
							        <li class="tab"><a href="#ceo6">REGISTER</a></li>
							        <li class="tab"><a href="#ceo7">CONTACT</a></li>
							      </ul>
							    </div>
							    <div class="card-content code">
							    	<div id="ceo4">
					...
					<article id="silhouette">
							<h2 class="major">CEO</h2>
							  ...
							  <div class="card" id="event-card-bg">
							    <div class="card-tabs">
							      <ul class="tabs tabs-transparent">
							        <li class="tab"><a class="active" href="#SILHOUETTE4">WHAT?</a></li>
							        <li class="tab"><a href="#SILHOUETTE5">WHY?</a></li>
							        <li class="tab"><a href="#SILHOUETTE6">REGISTER</a></li>
							        <li class="tab"><a href="#SILHOUETTE7">CONTACT</a></li>
							      </ul>
							    </div>
							    <div class="card-content code">
							    	<div id="SILHOUETTE4">
					...
					<article id="ad-venture">
							<h2 class="major">ad-venture</h2>
							  ...
							  <div class="card" id="event-card-bg">
							    <div class="card-tabs">
							      <ul class="tabs tabs-transparent">
							        <li class="tab"><a class="active" href="#ad-venture4">WHAT?</a></li>
							        <li class="tab"><a href="#ad-venture5">WHY?</a></li>
							        <li class="tab"><a href="#ad-venture6">REGISTER</a></li>
							        <li class="tab"><a href="#Sad-venture7">CONTACT</a></li>
							      </ul>
							    </div>
							    <div class="card-content code">
							    	<div id="ad-venture4">
							  ...
							  <div class="card" id="event-card-bg">
							    <div class="card-tabs">
							      <ul class="tabs tabs-transparent">
							        ...
							        <li class="tab"><a href="#bizmantra6">REGISTER</a></li>
							        <li class="tab"><a href="#bizmantra7">CONTACT</a></li>
							      </ul>
							    </div>
							    <div class="card-content code">
							    	<div id="bizmantra4">
